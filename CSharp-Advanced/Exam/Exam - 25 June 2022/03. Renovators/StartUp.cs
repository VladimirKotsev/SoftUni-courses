...
namespace Renovators
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            ////Console.WriteLine("-----------------My Tests---------------------");

            ////Catalog MyCatalog = new Catalog("Renovators", 5, "Kitchen");

            ////Renovator MyFirstRenovator = new Renovator("Vladko", "Plumber", 200, 9);
            ////Renovator MySecondRenovator = new Renovator("Ivan", "Coder", 450, 7);
            ////Renovator MyThirdRenovator = new Renovator("Anrea", "Painter", 120, );
            ///
